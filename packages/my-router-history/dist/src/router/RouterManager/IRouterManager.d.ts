 ...
 */
export declare type URLChangeListener = {
 ...
 * @interface URLChangeListener
 */
export declare type BeforeRouteEnterListener = {
 ...
 */
export declare type DestroyStateListener = {
 ...
 */
export declare type BeforeUpdateListener = {
