(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["my-router-vue"] = factory();
	else
		root["my-router-vue"] = factory();
...
var _RouterView = __webpack_require__(50);

var _RouterView2 = _interopRequireDefault(_RouterView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _RouterView2.default; //
//
//
//
//
...
exports.default = {
    ...
    watch: {
        finish: function finish(newValue, oldValue) {
...
var RouterView_1 = __webpack_require__(48);
var installed = false;
var MyRouterVue = {
...
exports.MyRouterVue = MyRouterVue;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_RouterView_vue__ = __webpack_require__(27);
...
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_RouterView_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_RouterView_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0fb8a451_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_RouterView_vue__ = __webpack_require__(95);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-0fb8a451"
/* moduleIdentifier (server only) */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0fb8a451_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_RouterView_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/router/router-view/RouterView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0fb8a451", Component.options)
  } else {
    hotAPI.reload("data-v-0fb8a451", Component.options)
  }
...
exports.default = {
    ...
    components: {
        'loading-bar': __webpack_require__(92).default
    },
    mounted: function () {
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            //增添事件监听
                            this._routerManger.addURLChangeListener(function () {
                                var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(result, from, to, clearState) {
                                    var oldPage, newPage;
                                        ...
                                        while (1) {
                                            switch (_context.prev = _context.next) {
                                                case 0:
                                                    ...
                                                    //老页面
                                                    oldPage = from && from.otherData ? from.otherData.page : undefined;
                                                    //新页面

                                                    newPage = to && to.otherData ? to.otherData.page : undefined;
                                                    //创建动画名称，是否是路由访问的第一页，如果是不显示动画

                                                    if (!_this._first) {
                                                        _this._first = true;
                                                    } else {
                                                        _this.animationName = result.toLowerCase();
                                                    }
                                                    if (oldPage && oldPage.dom && typeof oldPage.dom.$emit === 'function') {
                                                        // 执行beforeRouteLeave
                                                        oldPage.dom.$emit("beforeRouteLeave", (0, _assign2.default)({}, from, { otherData: undefined }), (0, _assign2.default)({}, to, { otherData: undefined }));
                                                    }
                                                    // 查看老页面是否存在，不存在就创建新页面
                                                    ...
                                                    // 创建新页面
                                                    newPage = _this.createPage(to);
                                                    to.otherData.page = newPage;
                                                    // 等待控件渲染完成（包括异步控件）
                                                    _this.loading = true;
                                                    _this.pageComponent = null;
                                                    _context.next = 14;
                                                    return newPage.loadComponent();

                                                case 14:
                                                    _this.loading = false;
                                                    // 加载页面
                                                    _this.addPageDom(newPage);
                                                    _context.next = 20;
                                                    break;

                                                case 18:
                                                    // 加载页面
                                                    _this.pageComponent = newPage.pageComponent;
                                                    // 修复红土航空 #6119
                                                    _this.cachePageMap[newPage.name] = newPage;
                                                ...
                                                case 22:
                                                    ...
                                                    console.error(_context.t0, "router error!");
                            ...
                            //增加移除事件监听
                            this._routerManger.addDestroyStateListener(function (clearState) {
                                clearState.forEach(function (item) {
                                    // 销毁过期页面
                                    if (item.otherData.page) {
                                        _this.deletePageDom(item.otherData.page);
                                    }
                                });
                                _this.$forceUpdate();
                            });
    ...
    methods: {
        //创建新页面
        createPage: function createPage(routeData) {
            ...
            //获取路由配置的注册的控件
            var pageComponent = routeData.routeConfig.component;
            ...
            if (typeof pageComponent == 'function') {
                ...
                loadComponent = function loadComponent() {
                    return new _promise2.default(function (resolve, reject) {
                        //如果返回的是promise，则集成
                        var result = pageComponent(resolve, reject);
                        if (result instanceof _promise2.default) {
                            result.then(resolve, reject);
                        }
                    });
                };
            } else if (pageComponent instanceof _promise2.default) {
                loadComponent = function loadComponent() {
                ...
                //如果是一个对象，直接返回对象
                loadComponent = function loadComponent() {
                    return _promise2.default.resolve(pageComponent);
                };
            }
        ...
        //将具体dom关联到page上面
        addPageDom: function addPageDom(page) {
            var _this2 = this;
            ...
            if (page) {
                ...
                this.$nextTick(function () {
                    page.dom = _this2.$refs.showPage;
                });
            }
        },

        //移除页面的dom元素
        deletePageDom: function deletePageDom(page) {
            this.cachePageNameList.splice((0, _from2.default)(this.cachePageNameList).indexOf(page.name), 1);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_loading_bar_vue__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_570a0b48_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_bar_vue__ = __webpack_require__(94);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-570a0b48"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_570a0b48_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_bar_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/router/loading-bar/loading-bar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-570a0b48", Component.options)
  } else {
    hotAPI.reload("data-v-570a0b48", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "loading-bar" }, [
    _vm.justFinished || !_vm.finish
      ? _c("div", {
          staticClass: "loading-bar_bar",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-570a0b48", esExports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("loading-bar", { attrs: { finish: !_vm.loading } }),
      _vm._v(" "),
      _vm.hasAnimation
        ? [
            _c(
              ...
              [
                _c(
                  "keep-alive",
                  { attrs: { include: _vm.cachePageNameList } },
                  [
                    _vm.pageComponent
